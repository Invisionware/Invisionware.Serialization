...
namespace TextSerializationTests
{
	...
	public class DateTimeDto : IEquatable<DateTimeDto>
	{
		...
		public bool Equals (DateTimeDto other)
		{
			...
			return DateTime.Equals(this.DateTime.Date, other.DateTime.Date) 
				   && Double.Equals(this.TimeSpan.TotalHours, other.TimeSpan.TotalHours) 
				   && DateTime.Equals(this.DateTimeOffset.Date, other.DateTimeOffset.Date);
		}
