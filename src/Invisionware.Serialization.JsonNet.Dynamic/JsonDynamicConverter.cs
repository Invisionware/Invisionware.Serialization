	...
	public class JsonDynamicConverter : JsonConverter
	{
		...
		private void BuildCacheOfClasses()
		{
			...
			var typesWithMyAttribute =
				...
				let attribute = t.GetAttributeOfType<JsonDynamicTypeAttribute>()
				where attribute != null && !t.IsPrimitive //&& !t.FullName.StartsWith("System.") && !t.FullName.StartsWith("Microsoft.") && !t.IsCOMObject
				select new { Type = t, Attributes = attribute };
